...
public class KalmanDriverHPS extends Driver {
    ...
    public void detectorChanged(Detector det) {
        ...
        double bFieldKal = fm.getField(new Vec(0., 500., 0.)).mag();
        if (verbose)
            System.out.format("\n*** HPS Bfield at (0,0,500)=%12.5e,  Kalman Bfield at (0,500,0)=%12.5e\n\n", bField, bFieldKal);
    ...
    public void process(EventHeader event) {
        ...
        for (Track trk : tracks) {
            ...
            if (createSeed) { // Start with the linear helix fit
                ...
                double bflyr1 = fm.getField(newPivot).mag();
            ...
            if (fullKalmanTrack != null) {
                ...
                if (verbose) {
                    Vec Borig = fm.getField(new Vec(0., 0., 0.));
