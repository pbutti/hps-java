...
public final class HodoscopeChannel extends BaseConditionsObject {
    ...
    /**
     * Specifies a scintillator that is positioned on the bottom half
     * of the hodoscope.
     */
    public static final int BOTTOM = -1;
    /**
     * Specifies a scintillator that is positioned on the first
     * hodoscope layer - i.e. the layer closest to the target.
     */
    public static final int LAYER_1 = 0;
    /**
     * Specifies a scintillator that is positioned on the second
     * hodoscope layer - i.e. the layer farthest from the target.
     */
    public static final int LAYER_2 = 1;
    /**
     * Specifies the scintillator fiber optic bundle hole that is
     * closest to the calorimeter center.
     */
    public static final int HOLE_LOW_X = -1;
    /**
     * Specifies the scintillator fiber optic bundle hole that is
     * closest to the positron-side of the calorimeter.
     */
    public static final int HOLE_HIGH_X = 1;
    /**
     * Specifies that a scintillator has only one fiber optic bundle
     * hole.
     */
    ...
    /**
     * Indicates whether or not this scintillator is located on the
     * bottom half of the hodoscope.
     * @return Returns <code>true</code> if the scintillator is on 
     * the bottom half and <code>false</code> otherwise.
     */
    ...
    /**
     * Indicates whether or not this scintillator is located on layer
     * 1 of the hodoscope.
     * @return Returns <code>true</code> if the scintillator is on 
     * layer 1 and <code>false</code> otherwise.
     */
     ...
     * 2 of the hodoscope.
     * @return Returns <code>true</code> if the scintillator is on 
     * layer 2 and <code>false</code> otherwise.
     */
    ...
    /**
     * Indicates whether or not this scintillator channel belongs to
     * a scintillator with multiple FADC channel.
     * @return Returns <code>true</code> if the channel belongs to
     * a multi-channel scintillator and otherwise returns
     * <code>false</code>.
     */
    ...
    /**
     * Indicates whether or not this scintillator channel belongs to
     * a scintillator with only one FADC channel.
     * @return Returns <code>true</code> if the channel belongs to
     * a single-channel scintillator and otherwise returns
     * <code>false</code>.
     */
    ...
    /**
     * Indicates whether or not this scintillator is located on the
     * top half of the hodoscope.
     * @return Returns <code>true</code> if the scintillator is on 
     * the top half and <code>false</code> otherwise.
     */
    ...
    /**
     * Gets the hole number for the channel. For scintillators that
     * only have a single hole, this will be <code>0</code>. It will
     * otherwise be either <code>-1</code> or <code>1</code>.
     * <br/><br/>
     * Static integer representation of the allowed values can be
     * found in {@link
     ...
     * <code>0</code> to <code>4</code>, with higher values
     * representing scintillators closer to the positron-side of the
     * calorimeter.
     ...
     * <code>-1</code> or <code>1</code>, with the former indicating
     * the bottom half of the hodoscope and the latter indicating the
     * top half of the hodoscope.
     * <br/><br/>
     * Static integer representation of the allowed values can be
     * found in {@link
     * org.hps.conditions.hodoscope.HodoscopeChannel#TOP TOP} and
     * {@link
    ...
    /**
     * Gets the layer number (also referred to as z-index) of the
     * scintillator. This value is either <code>0</code> for layer 1
     * or <code>1</code> for layer 2.
     * Static integer representation of the allowed values can be
     * found in {@link
     * org.hps.conditions.hodoscope.HodoscopeChannel#LAYER_1 LAYER_1}
     * and {@link
    ...
    /**
     * Specifies whether or not the scintillator is positioned on the
     * top half of the calorimeter or not. A value of <code>0</code>
     * means that it is not, and a value of <code>1</code> means that
     * it is.
     * @return Returns either <code>0</code> for <code>false</code>
     * or <code>1</code> for <code>true</code>.
     */
    @Field(names = {"top"})
