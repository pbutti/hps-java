 ...
 * @author tknelson
 */
public class SiStripsThinSensor implements SiSensorElectrodes
{
    ...
    public SiStripsThinSensor(){
         
    };
    // Constructors
    //=============
    public SiStripsThinSensor(ChargeCarrier carrier, double pitch, IDetectorElement detector, ITransform3D parent_to_local)
    {
...
//        System.out.println("                        distance: "+((SiSensor)detector).getBiasSurface(carrier).getDistance());
    ...
    public SiStripsThinSensor(ChargeCarrier carrier, double pitch, int nstrips, IDetectorElement detector, ITransform3D parent_to_local)
    {
        setCarrier(carrier);
        setPitch(pitch);
        setGeometry(((SiSensor)detector).getBiasSurface(carrier).transformed(parent_to_local));
    ...
    public SiStripsThinSensor(ChargeCarrier carrier, double pitch, int nstrips, IDetectorElement detector, ITransform3D parent_to_local ,ITransform3D misalignment){
         
    }
     
    public SiStripsThinSensor(ChargeCarrier carrier, double pitch,  IDetectorElement detector, ITransform3D parent_to_local ,ITransform3D misalignment){
    ...
    public Polygon3D getGeometry()
    {
        ...
        _geometry = new Polygon3D(newvertices);
        return _geometry;
    }
