    ...
    public void process(EventHeader event) {
        ...
        for (GenericObject gblSCD : gblSCDList) {
            ...
            if (i == 666)
                ...
                utopresid[i - 1].fill(resid);//x is the double value in the generic object                  //                aida.histogram2D(plotDir + triggerType + "/"+uresDir + "HalfModule " + i + " Top u Residual vs. u").fill(utrk,resid);//x is the double value in the generic object                 
            //                aida.histogram2D(plotDir + triggerType + "/"+uresDir + "HalfModule " + i + " Top u Residual vs. v").fill(vtrk,resid);//x is the double value in the generic object                 
                ...
                ubotresid[i - 1].fill(resid);//x is the double value in the generic object                             //                aida.histogram2D(plotDir + triggerType + "/"+uresDir + "HalfModule " + i + " Bot u Residual vs. u").fill(utrk,resid);//x is the double value in the generic object                 
