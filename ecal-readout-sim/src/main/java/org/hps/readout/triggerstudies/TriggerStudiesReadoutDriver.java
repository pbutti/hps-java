...
public class TriggerStudiesReadoutDriver extends TriggerDriver {
    /**
    ...
    /**
     * Defines the cluster energy lower-bound cut threshold.Units are
     * in GeV.
     */
    private double clusterEnergyLowerBound = 0.100;
    ...
    public void process(EventHeader event) {
        ...
        // If there exists a cluster in the calorimeter with energy
        // greater than the threshold, this is a valid event.
        for(Cluster cluster : clusters) {
            if(cluster.getEnergy() >= clusterEnergyLowerBound) {
                sendTrigger();
                break;
            }
        }
    ...
    /**
     * Sets the cluster energy lower bound cut threshold. Units are
     * in GeV.
     * @param clusterEnergyLowerBound - The threshold. Clusters with
     * an energy below this value will not trigger.
     */
    public void setClusterEnergyLowerBound(double clusterEnergyLowerBound) {
        this.clusterEnergyLowerBound = clusterEnergyLowerBound;
    }
